...
const PostItem = () => {
    ...
    const fetchCategories = async () => {
      try {
        const res = await fetch(
          `${"https://d202e0cc-9257-4a32-8c3b-d99083c7ea0b-00-24ny4n04qaxdg.janeway.replit.dev"}/get-categories.php`
        );
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch(
      `${"https://d202e0cc-9257-4a32-8c3b-d99083c7ea0b-00-24ny4n04qaxdg.janeway.replit.dev"}/post-item.php`,
      {
        method: "POST",
