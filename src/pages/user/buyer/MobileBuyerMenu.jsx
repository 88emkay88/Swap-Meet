    ...
    <>
      ...
      >
        ...
        <ul className="p-6 bg-white/88 backdrop-blur-3xl rounded-b-2xl space-y-4">
          <Link to="/buyer-dashboard" className="block text-lg">
            Dashboard
          </Link>
          <Link to="/buyer-dashboard/favorites" className="block text-lg">
            Favorites
          </Link>
          ...
          <Link to="/buyer-dashboard/profile">Settings</Link>
          <button className="flex mt-4" onClick={logout}>
            Log Out
          </button>
        </ul>
      </div>
