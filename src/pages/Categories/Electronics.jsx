...
const Electronics = () => {
  ...
  return (
    <div>
      ...
      {/* Background picture */}
      <div className="md:h-185 relative">
        <img
          src="/src/assets/images/electronics-page.jpg"
          alt="shopping cart with cereals"
          className="h-full w-full rounded-b-4xl"
        />

        <h1 className="absolute top-[58%] left-[20%] text-5xl md:top-[30%] md:left-[3%] cursor-default text-white font-bold md:text-12xl">
          Electronics
        </h1>
      </div>
