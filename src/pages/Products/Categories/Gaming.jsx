  ...
  return (
    <div>
      ...
      <div className="relative h-60 md:h-150">
        <img
          src="/src/assets/images/Gaming-bg.jpg"
          alt="Gaming hero"
          className="w-full h-full object-cover rounded-b-4xl"
        />
        <h1 className="absolute top-[68%] left-[20%] text-5xl md:top-[40%] md:left-[20%] cursor-default text-white font-bold md:text-12xl">
          Gaming
        </h1>
      </div>
