...
import HomeApplianceBg from "../../../assets/images/HomeAppliance-bg.jpg";
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <div className="relative h-60 md:h-150">
        ...
        />
        <h1 className="absolute top-[36%] left-[43%] text-3xl md:text-5xl md:top-[10%] md:left-[10%] cursor-default text-white font-bold md:text-12xl">
          Home Appliances
        </h1>
      </div>
