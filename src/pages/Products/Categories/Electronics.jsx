...
import electronicsBg from "../../../assets/images/electronics-page.jpg";
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <div className="relative h-60 md:h-150">
        ...
        />
        <h1 className="absolute top-[38%] left-[5%] text-6xl md:top-[30%] md:left-[3%] cursor-default text-white font-bold md:text-12xl">
          Electronics
        </h1>
      </div>
